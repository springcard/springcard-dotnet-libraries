...
namespace SpringCard.LibCs.Windows
{
	...
	public static class setupapi
	{
		...
		[DllImport("setupapi.dll", SetLastError = true)]
		static extern bool SetupDiGetDeviceRegistryPropertyW(IntPtr DeviceInfoSet, [In] ref SP_DEVINFO_DATA DeviceInfoData, uint Property, [Out] out UInt32 PropertyRegDataType, IntPtr PropertyBuffer, uint PropertyBufferSize, [In, Out] ref UInt32 RequiredSize);
		#endregion
