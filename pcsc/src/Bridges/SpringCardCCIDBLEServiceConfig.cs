...
namespace SpringCard.PCSC
{
	...
	public class CcidBleServiceConfig
	{
        ...
        public bool Create()
        {
            ...
            {
                serviceKey = null;
                Logger.Error("Exception : fails to create LOCAL_MACHINE KEY {0}", ex.Message);
                baseKey32 = null;
                baseKey64 = null;
                return false;
            }            
		...
		public string[] DeviceNames {
			get {
                ...
                {
                    k = null;
                    Logger.Error("Exception : fails to open LOCAL_MACHINE DeviceNames {0}", ex.Message);
                    return null;
                }
            }
		}
        ...
        public RegistryKey DeviceKey(string deviceName, Mode mode)
		{
            ...
            {
                k = null;
                Logger.Error("Exception : fails to open LOCAL_MACHINE DeviceKey {0} {1}", deviceName, ex.Message);
                return null;
            }
        }
		...
		public RegistryKey RuntimeKey(string deviceName, Mode mode)
		{
            ...
            {
                k = null;
                Logger.Error("Exception : fails to open LOCAL_MACHINE RuntimeKey {0}", ex.Message);
                return null;
            }
        }
        ...
        public RegistryKey DebugKey(Mode mode)
        {
            ...
            {
                k = null;
                Logger.Error("Exception : fails to open LOCAL_MACHINE DebugKey {0}", ex.Message);
                return null;
            }
        }
		...
		public bool InstallDevice(string DeviceName, string HostName, string FriendlyName)
		{
            ...
            {
                Logger.Error("UninstallDevice : {0}" + ex.Message);
            }
            return false;
        ...
        {            
            ...
            {
                Logger.Error("InstallRuntime : {0}" + ex.Message);
            }
        }

        public bool UninstallDevice(string deviceName)
		{
			RegistryKey k = null;
            RegistryKey key = null;
            try
        ...
        {            
            ...
            {
                Logger.Error("UninstallRuntime : {0}" + ex.Message);
            }
        }
        public void InstallDebug()
        {
            ...
            {
                Logger.Error("InstallDebug : {0}" + ex.Message);
            }
        }
