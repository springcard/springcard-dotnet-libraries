...
namespace SpringCard.Bluetooth
{
    public partial class BLE
    {
        ...
        public const string OrgBluetoothCharacteristicBatteryLevelUuid = "2A19";
        public const string OrgBluetoothCharacteristicBatteryPowerStateUuid = "2A1A";
        public const string OrgBluetoothCharacteristicBatteryLevelStateUuid = "2A1B";
        ...
        public class DeviceInfo
        {
            ...
            [ObsoleteAttribute("This property is obsolete. Use PrimaryServicesUuid instead.", true)]
            public BluetoothUuid PrimaryServiceUuid { get; protected set; }

            public List<BluetoothUuid> PrimaryServicesUuid { get; protected set; }
        ...
        public abstract class Adapter
        {
            ...
            public abstract bool ClearSystemCache();
