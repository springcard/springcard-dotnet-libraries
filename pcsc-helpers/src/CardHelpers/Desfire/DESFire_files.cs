...
namespace SpringCard.PCSC.CardHelpers
{
  ...
  public partial class Desfire
  {
    ...
    {
      long   status = DFCARD_WRONG_LENGTH;
      UInt32   temp;
    ...
    public long ChangeFileSettings(byte file_id, byte comm_mode, UInt16 access_rights)
    {
      ...
      byte file_type;
      byte old_comm_mode = comm_mode;
      DF_FILE_SETTINGS file_settings;

      //SesCommMode = (CommMode) comm_mode;
    ...
    again:
      ...
      {
        /* Under active authentication, the command Cmd.GetFileSettings requires CommMode.MAC */
        status = Command(0, COMPUTE_COMMAND_CMAC | APPEND_COMMAND_CMAC | CHECK_RESPONSE_CMAC | WANTS_OPERATION_OK | WANTS_ADDITIONAL_FRAME);
      }
      else
      {
