...
namespace SpringCard.PCSC.CardHelpers
{
  ...
  public partial class Desfire
  {
      ...
      switch (session_type)
      {
        case KEY_LEGACY_DES :
          ...
          for (i = 0; i < block_count; i++)
          {
            ...
            byte[] tmp  = DesfireCrypto.TripleDES_Decrypt(buffer, /*session_key*/SesAuthENCKey, dummy_iv);
        ...
        case KEY_ISO_AES :
          ...
          {           
            ...
            //2.
            byte[] tmp = DesfireCrypto.AES_Decrypt(buffer, /*session_key*/SesAuthENCKey, dummy_iv);
      ...
      switch (session_type)
      {
        case KEY_LEGACY_DES :
          ...
          for (i = 0; i < block_count; i++)
          {
            ...
            init_vector = DesfireCrypto.TripleDES_Decrypt(tmp, /*session_key*/SesAuthENCKey, dummy_iv);
        ...
        case KEY_ISO_3DES3K :
          ...
          */
          for (i = 0; i < block_count; i++)
          {
            ...
            byte[] tmp = new byte[block_size];
            Array.ConstrainedCopy(data, (int) (8*i), tmp, 0, (int) block_size);
            init_vector = DesfireCrypto.TripleDES_Encrypt(tmp, /*session_key*/SesAuthENCKey, dummy_iv);
        ...
        case KEY_ISO_AES :
          ...
          for (i = 0; i < block_count; i++)
          {
            ...
            init_vector = DesfireCrypto.AES_Encrypt(tmp, /*session_key*/SesAuthENCKey, dummy_iv);
    ...
    void SetSesAuthMACKey(byte[] pbKey)
    {
      SesAuthMACKey = pbKey;
    }
    void SetSesAuthENCKey(byte[] pbKey)
    {
      SesAuthENCKey = pbKey;
    }
